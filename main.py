...
values_string = ('SigmaR = ' + "{:.2E}".format(Decimal(ST_values[0])) + 
                     'MPa, SigmaP = ' + "{:.2E}".format(Decimal(ST_values[1])) + 
                     'MPa, Q = ' + "{:.2E}".format(Decimal(ST_values[2])) + 
                     'MPa, A = '+ "{:.2E}".format(Decimal(ST_values[3])) + 
                     'MPa, n = ' + "{:.2E}".format(Decimal(ST_values[4])))
