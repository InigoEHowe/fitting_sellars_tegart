...
fig_590=figure() # create a figure of log(sigma) vs T
...
for rate in rates:
    # Experiment
    exp_data = corrected_exp_data_hom590[abs(corrected_exp_data_hom590[:,3]-rate)<10**(-6)]
    fig_590.circle(exp_data[:,2],np.log10(exp_data[:,0]),color=colours[count],legend_label=str(rate)+'s-1')
    count = count + 1
...
# Baseline
fig_590.line(temp_range, SellarsTegart_01,color='Red',line_width=2,alpha=0.2)
fig_590.line(temp_range, SellarsTegart_1,color='Green',line_width=2,alpha=0.2)
fig_590.line(temp_range, SellarsTegart_10,color='Blue',line_width=2,alpha=0.2)

# Updated
fig_590.line('x','y',source=source_01,color='Red',line_width=2)
fig_590.line('x','y',source=source_1,color='Green',line_width=2)
fig_590.line('x','y',source=source_10,color='Blue',line_width=2)
    
## Set plot aesthetics
fig_590.xaxis[0].axis_label = 'T / Degrees C'
fig_590.yaxis[0].axis_label = 'log(Sigma / MPa)'
fig_590.x_range=Range1d(400, 600)
fig_590.y_range=Range1d(1, 2)
fig_590.xaxis.axis_label_text_font_size = "15pt"
fig_590.xaxis.major_label_text_font_size = "15pt"
fig_590.yaxis.axis_label_text_font_size = "15pt"
fig_590.yaxis.major_label_text_font_size = "15pt"
fig_590.title.text_font_size = '10pt'
